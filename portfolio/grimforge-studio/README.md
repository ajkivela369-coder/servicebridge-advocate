...
The app was informed by analysis of three YouTube references selected for different high-level strengths:

1. **Scholar / narrator reference** — calm authority, thesis-led analysis, explicit separation of canon and interpretation, intellectual cross-pollination, 2.5D visual treatment, in-world UI and restrained dry humor.
2. **Deadpan humor reference** — character comedy, callbacks, bureaucratic framing of absurd stakes, escalation and tonal collision.
3. **Premium chronicler reference** — formal narration, long chronological arcs, high production polish, cinematic motion-art language and strong faction/world continuity.
...
- Canon/source fact is visibly distinct from inference, interpretation and editorial framing.
